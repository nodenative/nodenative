...
TEST(UriTemplateTest, SimpleText) { checkUriTemplate("simpleText123", "simpleText123", "simpleText123"); }

TEST(UriTemplateTest, SimpleRegExp) { checkUriTemplate("simpleText[A-Z]+", "simpleText[A-Z]+", "simpleText[A-Z]+"); }
...
TEST(UriTemplateTest, UriTemplate) {
  initGlobalFormats();
  checkUriTemplate("someText{par1:formatName1}", "someText(?:[A-Z0-9\\-]{2}|[A-Z]{3})",
                   "someText((?:[A-Z0-9\\-]{2}|[A-Z]{3}))");
}
