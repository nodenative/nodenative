...
TEST(Crypto, EqConstInt) { EXPECT_EQ(1, 1); }

TEST(Crypto, PBKDF2) {
  const std::string password("password");
  std::string passwordEncExp("\x1E\\\xFF\xDB\xB3*\x1DM\x95\xCB\xC9\xD9VZ\xF1"
                             "eK\xB1\xAD\xCF"
                             "9\xFC\x7F\xB7\x95\xF0\xA5\x87\xD3"
                             "f\xD9"
                             "b\xFD\xDEgH'\xBF\x8Ep\xB0\xD8\xEA\x9E\b\x1D{\xC9\xEA\x86");
