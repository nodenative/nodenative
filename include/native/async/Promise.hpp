...
public:
  ...
  void resolve(R iVal) { _future.resolve(std::forward<R>(iVal)); }
  ...
  void reset() { _future = Future<R>(_future.getLoop()); }
...
public:
  ...
  void reset() { _future = Future<void>(_future.getLoop()); }
