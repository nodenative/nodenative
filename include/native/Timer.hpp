...
public:
     ...
     * @param iRepeat if it is non-zero, the callback fires first after `iTimeout` milliseconds and then repeatedly after `iRepeat` milliseconds.
     */
     ...
     * regardless of the callback execution duration, and will follow normal timer semantics in the case of a time-slice overrun.
     *
