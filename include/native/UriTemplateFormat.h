...
namespace native
{
     ...
     * For regex, do not use capturing groups or end anchor. if groups are really required, use non capturing groups e.g. (?:[A-Z0-9]{2}|[A-Z]{3})
     */
    ...
    public:
         ...
         *
         * @param iForExtraction True if require for extraction (include capturing groups), False for match only propose (exclude capturing groups to gain speed)
...
#endif // _NATIVE_URITEMPLATEFORMAT_H_
